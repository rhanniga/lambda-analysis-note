...
\begin{itemize}
	...
	\item  \makebox[7.5cm][l]{unlike-sign $p\pi$ in 0-20\% multiplicity bin RSB:}  \SI{1.160}{GeV/c^2}$< M_{p\pi} < $\SI{1.180}{GeV/c^2}
	\item  \makebox[7.5cm][l]{unlike-sign $p\pi$ in 20-50\% multiplicity bin RSB:}  \SI{1.160}{GeV/c^2}$< M_{p\pi} < $\SI{1.180}{GeV/c^2}
	\item  \makebox[7.5cm][l]{unlike-sign $p\pi$ in 50-80\% multiplicity bin RSB:}  \SI{1.160}{GeV/c^2}$< M_{p\pi} < $\SI{1.180}{GeV/c^2}
\end{itemize}
