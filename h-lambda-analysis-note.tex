...
As this analysis relies on the sideband subtraction technique, which in turn relies on our choice of sideband region, we should thoroughly investigate the effects of chooising different sideband regions on our final results. To do this, we vary the sideband region in the following ways:
...
\centering
\begin{subfigure}{
\includegraphics[width=4in]{figures/h_lambda_dphi_0_20_final.pdf}}
\end{subfigure}
\begin{subfigure}{
\includegraphics[width=4in]{figures/h_lambda_dphi_20_50_final.pdf}}
\end{subfigure}
\begin{subfigure}{
\includegraphics[width=4in]{figures/h_lambda_dphi_50_80_final.pdf}}
\end{subfigure}
...
\centering
\begin{subfigure}{
\includegraphics[width=4in]{figures/h_h_dphi_0_20_final.pdf}}
\end{subfigure}
\begin{subfigure}{
\includegraphics[width=4in]{figures/h_h_dphi_20_50_final.pdf}}
\end{subfigure}
\begin{subfigure}{
\includegraphics[width=4in]{figures/h_h_dphi_50_80_final.pdf}}
\end{subfigure}
...
\end{subfigure}
\caption{Final $h-\Lambda$ (top) and $h-h$ (bottom) $\Delta\varphi$ distributions in the low $p_{\text{T}}$ bin, with systematic erros shown in boxes. The jet-like components appear suppressed when compared to our full momentum range measurement.}
...
\end{subfigure}
\caption{Final $h-\Lambda$ (top) and $h-h$ (bottom) $\Delta\varphi$ distributions in the high $p_{\text{T}}$ bin, with systematic errors shown in boxes. There appears to be a slight enhancement of the jet-like compenents when compared to our full momentum range measurement.}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5in]{figures/v0_ratio_plot_lowpt.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5in]{figures/v0_ratio_plot_highpt.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5in]{figures/per_trigger_yields_lowpt.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=5in]{figures/per_trigger_yields_highpt.pdf}
