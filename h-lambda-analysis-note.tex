...
In the ($h-\Lambda$)/($h-\phi$) ratio, we see that the ratio in the near side of the jet is systematically higher across all multiplicity bins. We also observe that the ratio in the away side of the jet seems to decrease with respect to multiplicity.
...
\begin{figure}[ht]
\centering
\includegraphics[width=6in]{figures/lambda_phi_ratio_plot.pdf}
