...
\title{Strangeness Production ($\Lambda^{0}$) in Jets and Medium in p-Pb collisions at $\sqrt{s_{NN} = }$ 5.02 TeV}
\ShortTitle{Hadron-$\Lambda^{0}$ Correlations}   % appears on right page headers
%
...
Recent studies have shown that the ratio of the yield of $\Lambda^{0}$ baryons to charged pions differs between pp, p--Pb and PbPb collisions, specifically in the mid-$p_T$ region of $1-$\SI{4}{GeV/c}.  Additionally, similar studies have seen an increase in the $\Lambda^{0}/(\pi^{+} + \pi^{-})$ yields as a function of charged particle multiplicity in p--Pb collisions. The origin of this increase is still unknown.

By performing angular correlations of a high $p_T$ trigger hadron with an associated $\Lambda^{0}$ (or charged hadron as a proxy for a pion) in p-Pb events, we are able to separate out $\Lambda^{0}$ baryon production into three distinct kinematic regions:
\begin{itemize}
...
Larger statistics were needed to correct for a pairwise hadron-$\Lambda^{0}$ inefficiency due to track merging, which was done using a template created from analyzing the standard purpose generated pp MC production LHC18j2\_FAST, which is anchored to the LHC17q\_FAST production consisting of 15 TeV pp data. 
% TODO: UPDATE THIS
...
For the correlation, the reconstructed $\Lambda^{0}$ (and the associated hadron in the di-hadron case) is selected only in the momentum region:
...
\label{trigcuts}
For the trigger hadron tracks, Hybrid Global constrained tracks were accepted using the cuts supplied by \texttt{IsHybridGlobalConstrainedGlobal()} (i.e. track bit 768):
...
For the both the di-hadron and h-$\phi$ correlation, the trigger hadron is selected in the momentum region:

$${4.0 < p_{T} < \SI{8.0}{GeV/c}}$$

\section{$\phi$(1020) Reconstruction}

The $\phi$(1020) candidates were reconstructed through the $\phi \rightarrow K^{+}K^{-}$ decay channel.  Kaon candidate tracks are selected from the pool of global tracks with additional wide cuts on $n\sigma_{TPC}$ and $n\sigma_{TOF}$ (fig. \ref{nsigma}):
...
\centering
\begin{subfigure}{
\includegraphics[width=3in]{images/nsigmatof_track1024.pdf}}
\end{subfigure}
\begin{subfigure}{
\includegraphics[width=3in]{images/nsigmatpc_track1024.pdf}}
\end{subfigure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=3in]{images/PIDnsigmaTPCvsTOF.pdf}
...
\centering
\begin{subfigure}{
\includegraphics[width=3in]{images/narrowmass_invmass.pdf}}
\end{subfigure}
\begin{subfigure}{
\includegraphics[width=3in]{images/corrected_invmass.pdf}}
\end{subfigure}
...
\begin{itemize}
	\item \makebox[7.5cm][l]{unlike-sign kaons in $\phi$ mass region:}  \SI{1.014}{GeV/c^2}$< M_{KK} < $\SI{1.026}{GeV/c^2}
	\item  \makebox[7.5cm][l]{like-sign kaons in $\phi$ mass region:}  \SI{1.014}{GeV/c^2}$< M_{KK} < $\SI{1.026}{GeV/c^2}
	\item  \makebox[7.5cm][l]{unlike-sign kaons in left sideband region:}  \SI{0.995}{GeV/c^2}$< M_{KK} < $\SI{1.005}{GeV/c^2}
	\item  \makebox[7.5cm][l]{like-sign kaons in left sideband region:} \SI{0.995}{GeV/c^2}$< M_{KK} < $\SI{1.005}{GeV/c^2}
	\item  \makebox[7.5cm][l]{unlike-sign kaons in right sideband region:} \SI{1.040}{GeV/c^2}$< M_{KK} < $\SI{1.060}{GeV/c^2}
	\item  \makebox[7.5cm][l]{like-sign kaons in right sideband region:} \SI{1.040}{GeV/c^2}$< M_{KK} < $\SI{1.060}{GeV/c^2}
\end{itemize}
...
\begin{figure}[ht]
\centering
\includegraphics[width=4in]{images/mixed_USpeak_mult_0_20.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=3.5in]{images/mixedeventstatsUS0_20.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=4in]{images/2D_uncorr_hKK.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=4in]{images/2D_corr_hKK.pdf}
